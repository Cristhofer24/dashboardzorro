...
_NzFlexDirective.ɵfac = function NzFlexDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NzFlexDirective)();
};
...
_NzFlexModule.ɵfac = function NzFlexModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NzFlexModule)();
};
