...
var __PRIVATE_IndexedDbOfflineComponentProvider = class ___PRIVATE_IndexedDbOfflineComponentProvider extends MemoryOfflineComponentProvider {
  ...
  initialize(e) {
    return __async(this, null, function* () {
      yield __superGet(___PRIVATE_IndexedDbOfflineComponentProvider.prototype, this, "initialize").call(this, e), yield this.Wa.initialize(this, e), // Enqueue writes from a previous session
      yield __PRIVATE_syncEngineEnsureWriteCallbacks(this.Wa.syncEngine), yield __PRIVATE_fillWritePipeline(this.Wa.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
  ...
  initialize(e) {
    return __async(this, null, function* () {
      ...
      yield this.persistence.yi((e2) => __async(this, null, function* () {
        yield __PRIVATE_syncEngineApplyPrimaryState(this.Wa.syncEngine, e2), this.gcScheduler && (e2 && !this.gcScheduler.started ? this.gcScheduler.start() : e2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e2 || this.indexBackfillerScheduler.stop());
      }));
    });
  }
  createSharedClientState(e) {
...
var __PRIVATE_BundleReaderImpl = class {
  ...
  Ua() {
    return __async(this, null, function* () {
      return yield this.getMetadata(), this.Ja();
    });
  }
  /**
  ...
  Xa(e) {
    return __async(this, null, function* () {
      for (; this.buffer.length < e; ) {
        (yield this.tu()) && this.Za("Reached the end of bundle when more is expected.");
      }
...
var __PRIVATE_AsyncQueueImpl = class {
  ...
  Ru() {
    return __async(this, null, function* () {
      if (0 !== this.uu.length) {
        try {
          yield this.uu[0](), this.uu.shift(), this.t_.reset();
        } catch (e) {
